#pragma once
// Generated by tools/gen_cockpit_planar.py. Entries are scan-major Amiga plane bytes,
// ready to copy to an interleaved Bitmap; no pixel or character-set expansion remains.
extern "C" const unsigned char rof_cockpit_planar[];
extern "C" const unsigned char rof_cockpit_planar_end[];
